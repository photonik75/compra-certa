...
| Tela Entre na sua conta > Campo Senha > Obrigatório e mínimo de 8 caracteres | `LOG-3` | Confirma que a senha vazia ou com 7 caracteres é rejeitada com a mensagem correspondente e que uma senha com 8 caracteres é aceita. |
